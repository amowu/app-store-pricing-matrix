 ...
 */
export const tiers = get(jsonData, ["data", "pricingTiers"], []);
 ...
 */
export const stems = tiers.map(({ tierStem }) => tierStem);
 ...
 */
export const countries = _.chain(
  tiers.map(({ pricingInfo }) =>
 ...
 */
export const currencies = _.chain(
  tiers.map(({ pricingInfo }) =>
